...
This repo contains the trained parameter advisor models for Scallop and StringTie2. For details on these models, please read our paper "Data-driven AI system for learning how to run transcript assemblers" that has been accepted in Genome Biology (https://link.springer.com/article/10.1186/s13059-026-04085-z). You can also find it in Zenodo (https://doi.org/10.5281/zenodo.19322730).
...
### Other folders and files
   ...
   (1) datasets/: contains details of the training datasets and the test datasets. 
