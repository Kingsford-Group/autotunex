...
if __name__ == '__main__':
    ...
    with open("./stringtie_all.pkl", "wb") as f:
        pickle.dump(data_format, f)
    datasets = ["./stringtie_all.pkl"]

    saved_model_path = "./HEBO/NAP/log/TRAIN/stringtie/NAP-SLiidRL-MLP-CondP-v0/2025-05-13-21-40-47/"
    ...
    logpath = os.path.join("./HEBO/NAP/", "log/TEST", "stringtie", env_spec["env_id"], datetime.strftime(datetime.now(), "%Y-%m-%d-%H-%M-%S"))
